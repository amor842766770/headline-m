...
import CommentPost from './components/commnt-post';
...
export default {
  ...
  data() {
    return {
      ...
      totalCommentCount: 0,
      isCommentShow: false,//评论弹出层开关
      commentList: [],//评论列表
      isReplyShow: false,//评论回复弹出层开关
      currentComment: {}//当前点击的回复评论项
    }
  },
  provide: function () {
    return {
  ...
  methods: {
    ...
    tolist() {
      document.querySelector("#commentlist").scrollIntoView(true)
    },
    onPostSuccess(data) {
      // 关闭弹出层
